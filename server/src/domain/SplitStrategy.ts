export interface SplitStrategy {
    calculateSplits(amount: number, userIds: number[], options?: any): { userId: number, amount: number }[];
    getType(): string;
}

export class EqualSplitStrategy implements SplitStrategy {
    calculateSplits(amount: number, userIds: number[]): { userId: number, amount: number }[] {
...
export class ExactSplitStrategy implements SplitStrategy {
    calculateSplits(amount: number, userIds: number[], options: { amounts: number[] }): { userId: number, amount: number }[] {
...
export class PercentSplitStrategy implements SplitStrategy {
    calculateSplits(amount: number, userIds: number[], options: { percentages: number[] }): { userId: number, amount: number }[] {
