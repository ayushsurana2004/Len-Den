...
import { LayoutDashboard, Users, User, LogOut, TrendingUp, Plus, UserPlus } from 'lucide-react';
        ...
        <div className="w-72 bg-slate-950/20 backdrop-blur-2xl border-r border-white/5 flex flex-col h-full overflow-hidden relative">
            ...
            <div className="p-8 pb-6">
                <Link to="/" className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-black tracking-tighter text-white">Splitwise</h2>
                                            ...
                                            >
                                                <div className="p-3 space-y-2">
                                                    ...
                                                    {groupMembers.map(member => (
                                                        <div key={member.id} className="flex items-center gap-3 py-2 px-2 rounded-xl hover:bg-white/5 transition-all group/member">
                                                            <div className="w-7 h-7 rounded-xl bg-slate-800 flex items-center justify-center text-[11px] font-black text-slate-500 border border-white/5 group-hover/member:bg-emerald-500 group-hover/member:text-slate-950 group-hover/member:border-emerald-400 transition-all">
                                                                {member.name.charAt(0)}
                                                            </div>
                                                            <div className="flex flex-col">
                                                                <span className="text-[11px] font-bold text-slate-400 group-hover/member:text-slate-200 transition-colors">
                                                                    {member.name}
                                                                </span>
